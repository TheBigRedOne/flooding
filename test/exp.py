...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', type=str, default='baseline',
                        ...
                        help='Experiment mode (baseline or solution)')
    args = parser.parse_args()
    info(f'Running experiment in {args.mode} mode\n')
    ...
    info(f'Starting consumer and producer in {args.mode} mode\n')
    consumer.cmd(f"/home/vagrant/mini-ndn/flooding/consumer --mode {args.mode} &> /home/vagrant/mini-ndn/flooding/consumer.log &")
    producer.cmd(f"/home/vagrant/mini-ndn/flooding/producer --mode {args.mode} &> /home/vagrant/mini-ndn/flooding/producer.log &")
    sleep(120)
