...
def main() -> int:
    ...
    lines = [
        ...
        *emit_list("SOLUTION_NODE_PCAPS", node_pcaps, 22),
        ...
        "\tsh $^ $@",
        "",
        "results/solution/consumer_capture.csv: results/solution/consumer_capture.pcap",
        ...
        "\tpython3 $^ $@",
        "",
        "results/solution/disruption_times.pdf: experiment/tool/plot_latency.py results/solution/consumer_capture.csv",
        "\tpython3 $^ $@",
        "",
        "results/solution/disruption_metrics.txt: experiment/tool/plot_latency.py results/solution/consumer_capture.csv",
        "\tpython3 $^ $@",
        "",
        "results/solution/loss_comparison.pdf: experiment/tool/plot_loss.py results/solution/consumer_capture.csv",
        "\tpython3 $^ $@",
        "",
        "results/solution/loss_ratio.txt: experiment/tool/plot_loss.py results/solution/consumer_capture.csv",
        "\tpython3 $^ $@",
        "",
        "results/solution/throughput_timeseries.pdf: experiment/tool/plot_throughput.py results/solution/consumer_capture.csv",
        "\tpython3 $^ $@",
        "",
        "results/solution/throughput_metrics.txt: experiment/tool/plot_throughput.py results/solution/consumer_capture.csv",
        "\tpython3 $^ $@",
        "",
        ...
        "\tpython3 $^ $@",
        "",
        "results/solution/overhead_total.txt: experiment/tool/plot_overhead.py results/solution/network_overhead.csv",
        "\tpython3 $^ $@",
        "",
