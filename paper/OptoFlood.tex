...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/baseline_throughput.pdf} % Baseline 的结果文件
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/solution_throughput.pdf} % Solution 的结果文件
