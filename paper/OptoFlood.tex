...
\begin{figure}[t]
	...
	\caption{NDN Producer Mobility Problem \ryo{should this not be side-by-side with the solution Fig.\ref{fig:NDN Producer Mobility Problem Solution}?}}
