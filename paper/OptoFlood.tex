...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{throughput_comparison.pdf}
    \caption{Consumer throughput under baseline forwarding and OptoFlood}
    \label{fig:throughput_comparison}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{service_disruption_comparison.pdf}
    \caption{Per-handoff service disruption under baseline forwarding and OptoFlood}
    \label{fig:service_disruption_comparison}
\end{figure}
