...
The forwarder automatically converts an unsatisfied Interest into a scoped flood when PIT lookup fails and no FIB/TFIB next hop exists. It sets and enforces the native \emph{HopLimit} (default~3) before flooding, decrementing it at each hop.
